...
class MyRobot(wpilib.TimedRobot):
    ...
    def teleopPeriodic(self):
        self.drive_sm.run()
        print(f"FL: {self.fl_motor.getQuadraturePosition()}    FR: {self.fr_motor.getQuadraturePosition()}    BL: {self.fr_motor.getQuadraturePosition()}    BR: {self.fr_motor.getQuadraturePosition()}")
